      ...
      <div class="row">
        <div class="navigation ">
          <nav>
            ...
            <a href="equipmentreport.php" class="active">Report</a>
            </div>
              ...
              <div class="container" style="width: 1000px;">
                <div><br>
                  <table class="table table-hover">
                    ...
                    <tr>
                    <?php 
                    include("reportlistcontroller.php"); 
                    ?>
                    </tr>
                    <tr> 
                          <td>
                          <br><input type="button"  name="Back to Home" value="Back to Home" onclick="location.href='equipment.php'">
                          <br><td><br>
                          <input type="button"  name="Confirm" value="Confirm" onclick="location.href='equipment.php'">
                          </td>
                  </table>
