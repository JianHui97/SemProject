      ...
      <div class="row">
        <div class="navigation ">
          <nav>
            ...
            <a href="equipmentapproval.php" class="active">Equipement Approval</a><br>
    ...
    <div class="content">
      <form action="requestequipmentform.php" method="POST" class="container" style="border-style: outset;">
          <fieldset class="container">
            <legend><h2>Equipment Approval</h2></legend>
              ...
              <div class="container" style="width: 1000px;">
                <div><br>
                  <table class="table table-hover">
                    ...
                    <tr>
                    <?php 
                    include("equipmentapprovalcontroller.php"); 
                    ?>
                    </tr>
                    <!-- <tr> 
                          <td>
                         <input type="button"  name="Reject" value="Reject" onclick="location.href='equipmentreport.php'">
                          <br><td>
                          <input type="button"  name="Approve" value="Approve" onclick="location.href='equipmentreport.php'">
